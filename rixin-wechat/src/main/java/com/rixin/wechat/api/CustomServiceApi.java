...
import com.rixin.wechat.bean.entity.message.msg.Message;
import com.rixin.wechat.bean.response.BaseResponse;
import com.rixin.wechat.bean.response.kf.KfListResponse;
import com.rixin.wechat.bean.response.kf.MsgRecordResponse;
import com.rixin.wechat.bean.response.kf.SessionListResponse;
import com.rixin.wechat.bean.response.kf.WaitCaseResponse;

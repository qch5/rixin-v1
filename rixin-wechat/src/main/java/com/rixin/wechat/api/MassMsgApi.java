...
import com.rixin.wechat.bean.response.message.MessageSendResponse;
import com.rixin.wechat.utils.client.HttpUtil;
import com.rixin.wechat.Const;
import com.rixin.wechat.bean.entity.message.massmsg.MassMessage;
...
import com.rixin.wechat.bean.response.message.MessageSendStatusResponse;

...
import com.rixin.wechat.bean.entity.menu.MenuButtons;
import com.rixin.wechat.bean.response.BaseResponse;
import com.rixin.wechat.bean.response.menu.GetMenuResponse;
import com.rixin.wechat.bean.response.menu.TryMatchResponse;
import com.rixin.wechat.bean.response.menu.selfmenu.GetCurrentSelfMenuInfoResponse;

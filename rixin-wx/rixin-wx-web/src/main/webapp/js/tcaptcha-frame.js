!function(e) {
    ...
    , function(e, t, i) {
        ...
        var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
            ...
            , m = ["absolute", "fixed", "static", "relative"]
            , g = !!window.ActiveXObject && 8 == document.documentMode;
        e.exports = {
            extend: n,
            isObject: a,
            isFunction: s,
            ...
            getPos: function(e) {
                if ("undefined" != typeof e.offsetParent) {
                    for (var t = 0, i = 0; e; e = e.offsetParent) {
                        var r = f(e, "borderLeftWidth");
                        r = r && r.indexOf("px") > -1 ? parseInt(r, 10) : 0;
                        var n = f(e, "borderTopWidth");
    ...
    , function(e, t, i) {
        ...
        e.exports = function f() {
            var e, t, i, r, n, o, a = arguments[0], u = 1, h = arguments.length, l = !1;
            for ("boolean" == typeof a && (l = a,
                a = arguments[1] || {},
                u = 2),
                 (null == a || "object" != typeof a && "function" != typeof a) && (a = {}); u < h; ++u)
                if (null != (e = arguments[u]))
                    for (t in e)
                        i = d(a, t),
                        a !== (r = d(e, t)) && (l && r && (c(r) || (n = s(r))) ? (n ? (n = !1,
                            o = i && s(i) ? i : []) : o = i && c(i) ? i : {},
                            p(a, {
                                name: t,
                                newValue: f(l, o, r)
            ...
            for (var r = 0; r < e.length; r++) {
                ...
                if (o) {
                    ...
                    for (; a < n.parts.length; a++)
                        o.parts.push(u(n.parts[a], t))
                } else {
                    var s = [];
                    for (a = 0; a < n.parts.length; a++)
                        s.push(u(n.parts[a], t));
                    i[n.id] = {
                        id: n.id,
                        refs: 1,
                        parts: s
    ...
    , function(e, t, i) {
        ...
        function d(e, t, i, c) {
            try {
                var d = n[e].size[0]
                    ...
                    , h = 0;
                i ? (u = t.windowWidth,
                    h = t.windowHeight) : (u = r.getWindowWidth(),
                    h = r.getWindowHeight(),
                    t.windowWidth = u,
                    t.windowHeight = h);
                var l = "popup" == t.opts.type && t.opts.fwidth ? parseFloat(t.opts.fwidth) : 0;
                if (l > 0 && l <= 2 * d * 16) {
                    var m = parseInt(1e4 * (l / (16 * d))) / 1e4;
                    d = d * m * 16 + 3,
                        f = f * m * 16 + 3,
                    1 == c && t.readyFunc && t.readyFunc({
                        ...
                        t.sizeSC.height = parseInt(f),
                        t.posSC.top = "0px",
                        t.posSC.left = "0px"
                } else {
                    var g = Math.min(u / a.baseWidth)
                        , y = Math.min(h / a.baseWidth)
                        , v = r.isHorizontal(i, t) ? .85 * y : g
                        , b = r.getParentScale();
                    v = (v = 0 == b || 1 == b ? v > 1.3 ? 1.3 : v : b >= .5 ? v > 2 ? 2 : v : v > 3 ? 3 : v) < .85 ? .85 : v;
                    var S = parseInt(1e4 * v) / 1e4;
                    d = d * S * 16 + 3,
                        f = f * S * 16 + 3,
                    r.isMobileUa() || (d = n[e + "_pc"].width,
                        f = n[e + "_pc"].height,
                    p(e) || "popup" != t.opts.type || (f += 40)),
                        t.sizeSC.width = parseInt(d),
                        t.sizeSC.height = parseInt(f);
                    var w = h - f;
                    ...
                    if (t.posSC.left = n[e].hasBorder ? Math.floor((C - 2) / 2) + "px" : Math.floor(C / 2) + "px",
                        ...
                        if ("embed" === t.opts.type)
                            return void r.CSS(o.tIframe(), x);
                        var A = o.border();
                        A && r.setPopPosition(A, t.sizeSC.width, t.sizeSC.height, t.opts.sdkOpts),
                            r.setPopPosition(o.tIframe(), t.sizeSC.width, t.sizeSC.height, t.opts.sdkOpts);
                        var z = o.container();
                        z && (r.CSS(z, x),
                            t.TCaptchaFrame.setDivPosition(z))
                    }
                }
            } catch (O) {
                var E = s.perfectStack(O);
                s.send("ERROR_TYPE_FRAMEJS_CODE_ERROR", t.opts.appid, E || "setCaptchaIframeSizeAndPos code error")
            }
        }
        function f(e) {
            e.src = "about:blank",
        ...
        function u(e) {
            ...
            }(e), d = r.getWindowHeight(), f = r.getScrollTop();
            return (o = c[1] - f) >= e.sizeSC.height / 2 && d - o - p[1] / 2 >= e.sizeSC.height / 2 ? (a = c[1] + p[1] / 2 - e.sizeSC.height / 2,
                s = c[0] + 45,
                t = "top: 50%;",
                i = "top: 50%;") : o <= e.sizeSC.height / 2 ? (a = c[1] - o,
                s = c[0] + 45,
                i = t = "top: " + (o + p[1] / 2) / e.sizeSC.height * 100 + "%;") : d - o >= p[1] && d - o - p[1] / 2 <= e.sizeSC.height / 2 ? (a = d - e.sizeSC.height + f,
                s = c[0] + 45,
        ...
        e.exports = {
            ...
            createPreTrigerPoint: function(e) {
                ...
                if (t.opts.firstvrytype && 2 == t.opts.firstvrytype && (t.clientW = a.CONST_SLIDE_PTR.width + "px",
                    ...
                    var l = 0;
                    t.clientH.length > 2 && (l = t.clientH.substr(0, t.clientH.length - 2)),
    ...
    , , , , , , , , , , , , , , , , , , , , , , , , , , function(e, t, i) {
        ...
        var r = i(15)
            ...
            , w = new r("parent");
        function C() {
            return b || (b = this.init.apply(this, arguments))
        }
        C.prototype = {
            init: function(e) {
                var t = {
                                ...
                                case 3:
                                    ...
                                    t && t.ticket)
                                        ...
                                        if (t && t.src) {
                                            ...
                                            l.setCaptchaIframeSizeAndPos(r, e, !1, !0);
                                            var c = t.src;
                                            t.src.indexOf("http:") > -1 && e.opts.domain && e.opts.domain.indexOf("https:") > -1 && (c = (c = c.replace("http://captcha.qq.com", "https://ssl.captcha.qq.com")).replace("http://ssl.captcha.qq.com", "https://ssl.captcha.qq.com")),
                                                e.TCaptchaFrame.createSecurityCode(r, u(c))
                                        }
                                        e.securityIframe && l.setPosition(e, e.securityIframe)
                                    }
                                    return;
                                case 4:
                                ...
                                case 8:
                                    ...
                                    var p = {
                                        ...
                                        success: function(t) {
                                            ...
                                            l.setCaptchaIframeSizeAndPos(r, e, !0, !0),
                                    ...
                                    return void e.getPrehandle(p);
                                case 9:
                                    var d = window.document.getElementById("loading_animation");
                                        ...
                                        var f = {
                                            ...
                                            success: function(t) {
                                                ...
                                                var i = n.getCapType(t.capclass, t.subcapclass)
                                                    , r = a.tIframe();
                                                e.isPop && l.setCaptchaIframeSizeAndPos(i, e, !0, !0),
            ...
            prehandleSuccess: function(e) {
                ...
                try {
                    ...
                    "embed" == t.opts.type)
                        return l.setCaptchaIframeSizeAndPos(i, t, !1, !0),
                    ...
                    t.isPop ? (window.onresize = function() {
                        ...
                        ,
                        e.ticket ? l.smartverification(t, e) : setTimeout(function() {
                            l.setCaptchaIframeSizeAndPos(i, t, !1, !0),
    ...
    , function(e, t, i) {
        ...
        var s, c = (s = void 0,
            (s = navigator.languages && navigator.languages[0] ? navigator.languages[0] : navigator.language || navigator.userLanguage) ? s.toLowerCase().replace(/_/, "-") : null), p = {
            rightToLeft: !1
        };
        p.total = n,
            p.init = function(e) {
                var t, i = t = e ? /^\d+$/.test(e) ? o[e] || c || a : e.toLowerCase().replace(/_/, "-") : c || a;
                /-/.test(t) && (i = t.split("-")[0]),
                n[t] || (t = n[i] ? i : a);
                for (var s = n[t], d = 0; d < r.length; d++)
                    p[r[d]] = s[d] === undefined ? n[a][d] : s[d];
                "ar" !== t && "he" !== t && "iw" !== t || (p.rightToLeft = !0),
                    p.currentLanguage = t
            }
            ,
            p.init(),
                ...
                this.name = "TCaptchaFrameProxy",
                    ...
                    this.createSmartVerify = function() {
                        ...
                        var f = r.getPosStyle(e.opts)
                            , u = r.computeBaseFontSize();
                        e.opts.sdkOpts && e.opts.sdkOpts.width && e.opts.sdkOpts.height && (u *= e.opts.sdkOpts.width / (o.SMART_VERIFY_SZ.width * u));
                        var h = {
                        ...
                        r.CSS(i, h),
                            e.ele.appendChild(i),
                            r.setPopPosition(i, o.SMART_VERIFY_SZ.width * u, o.SMART_VERIFY_SZ.height * u, e.opts.sdkOpts)
                    }
                    ,
                    this.createFlimitDom = function() {
                        ...
                        e.opts.params.split("lang=")[1] && e.opts.params.split("lang=")[1].split("&")[0] && !e.opts.tcaptchaFlag && (i = e.opts.params.split("lang=")[1].split("&")[0],
                            e.langPack.init(i));
                        var n = r.createElement("div");
                        n.className = "tcaptcha-transform",
                        ...
                        if (p.className = "ticons transform-text",
                            ...
                            u.className = "ticons tback transform-eicon",
                                u.id = "transform_eicon";
                            var h = r.createElement("div");
                            h.className = "ticons tback transform-eb",
                                h.id = "transform_eb",
                                h.innerText = e.langPack.c11;
                            var l = r.createElement("p");
                            l.className = "ticons transform-eh",
                                l.id = "transform_eh",
                                e.langPack.c2.length > 20 ? (r.addClass(l, "middle-fontsize"),
                                    r.addClass(h, "middle-fontsize")) : e.langPack.c2.length > 15 && (r.addClass(l, "small-fontsize"),
                                    r.addClass(h, "small-fontsize")),
                                l.innerText = e.langPack.c2,
                                n.appendChild(u),
                                n.appendChild(h),
                                n.appendChild(l),
                    ...
                    this.createSecurityCode = function(t, o) {
                        try {
                            ...
                            if (s) {
                                ...
                                f.className = "tcaptcha-container",
                                    f.id = "tcaptcha_container",
                                    e._div = f;
                                var h = {
                                    width: e.sizeSC.width + "px",
                                    height: e.sizeSC.height + "px"
                                ...
                                if (this.hasSecurityCode()) {
                                    ...
                                    return r.CSS(e.securityIframe, l),
                                ...
                                "embed" != e.opts.type || "slidepuzzle_new" !== t && "slidepuzzle_opt" !== t ? (h.width = e.sizeSC.width + "px",
                                    h.height = e.sizeSC.height + "px") : (h.width = "300px",
                                    h.height = "230px"),
                                    r.CSS(v, h),
                                    e.securityIframe = v,
                                    e.ele.appendChild(v),
                            ...
                            var b = p.perfectStack(w);
                            p.send("ERROR_TYPE_FRAMEJS_CODE_ERROR", e.opts.appid, b || "createSecurityCode code error")
                        }
                        var S
                    }
                    ,
                        ...
                        try {
                            ...
                            if ("point" == e.opts.type) {
                                ...
                                d.rel = "stylesheet",
                                    ...
                                    setTimeout(function() {
                                        l(document.styleSheets[document.styleSheets.length - 1], ".tcaptcha-container:before", s, 0),
                                            l(document.styleSheets[document.styleSheets.length - 1], ".tcaptcha-container:after", c, 0)
                                    }, 1)
                            }
                            return r.CSS(t, {
                                top: i + "px",
                            ...
                            var f = p.perfectStack(u);
                            p.send("ERROR_TYPE_FRAMEJS_CODE_ERROR", e.opts.appid, f || "setDivPosition code error")
                        }
                    }
                    ,
